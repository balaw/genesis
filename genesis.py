...
#   script_prefix = '04ffff001d0104' + psz_prefix + chr(len(psz_timestamp)).encode('hex')
  ...
  script_prefix = '04ffff001d0104' + psz_prefix + codecs.encode(chr(len(psz_timestamp)).encode('utf-8'), 'hex').decode('utf-8')
#   print (script_prefix + psz_timestamp.encode('hex'))
  print(script_prefix + binascii.hexlify(psz_timestamp.encode('utf-8')).decode('utf-8'))
#   return (script_prefix + psz_timestamp.encode('hex')).decode('hex')
  return binascii.unhexlify((script_prefix + binascii.hexlify(psz_timestamp.encode('utf-8')).decode('utf-8')).encode('utf-8'))
...
#   return int(header_hash.encode("hex"), 16) < target
